...
IF '%1'=='' (
  ...
  "%phpCli%" -d include_path="C:\xampp\php\pear" "\xampp\php\phpdoc" %*
  GOTO :EOF
)
...
:run
SET found=1
ECHO Starting: "%phpCli%" "C:\xampp\php\phpdoc" -c "%iniFile%"
ECHO.
"%phpCli%"  -d include_path="C:\xampp\php\pear" "\xampp\php\phpdoc" -c "%iniFile%"
GOTO :EOF
