    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
         ...
         <li><a href="map.html"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> Lokasi</a></li><!-- edit -->
		 <li><a href="video.html"><span class="glyphicon glyphicon-facetime-video" aria-hidden="true"></span> Video</a></li> <!-- edit -->
      </ul>
	  ...
	  <div class="row featurette">
        <div class="col-md-5">
			<h2 class="featurette-heading">
				<p> <span class="glyphicon glyphicon-facetime-video" aria-hidden="true"></span> Video </p>
			</h2>
			<p class="lead">Berikut ini adalah tutorial bermain basket </p>
		</div>
      </div>
	  <div class="row featurette">
        <div class="col-md-5">
